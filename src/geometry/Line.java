...
public class Line {
    ...
    public Point intersectionWith(Line other) {
        Point p;
        double grad1 = this.gradient(this);
        double grad2 = gradient(other);
    ...
    public Point regularIntersection(Line line1, Line line2) {
        double x, y;
        double grad1 = gradient(line1);
        double yInt1 = yIntercept(line1, grad1);
        double grad2 = gradient(line2);
        double yInt2 = yIntercept(line2, grad2);
        /*
    ...
    public boolean pointOnLine(Point point) {
        double gradient = gradient(this);
        double yInt = yIntercept(this, gradient);
        double x = point.getX();
        double y = point.getY();
        //If line is vertical.
        ...
        if (Math.abs(y - (gradient * x + yInt)) < EPSILON) {
            return true;
        }
        return false;
    }
